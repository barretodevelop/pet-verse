        ...
        children: [
          ...
          Expanded(
            ...
            child: Container(
              width: double.infinity,
              decoration: BoxDecoration(
                color: _getStatusColor(slot.collaborationStatus!),
                borderRadius: BorderRadius.circular(ThemeConfig.borderRadius8),
              ),
              child: Stack(
                children: [
                  Center(
                    child: slot.petImageUrl?.isNotEmpty == true
                        ? ClipRRect(
                            borderRadius: BorderRadius.circular(ThemeConfig.borderRadius8),
                            child: Image.network(
                              slot.petImageUrl!,
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        slot.collaborationStatus!.emoji,
          ...
          Expanded(
            ...
            child: Column(
              children: [
                ...
                Text(
                  slot.collaborationStatus!.displayName,
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(
                        fontSize: 10,
                        color: _getStatusTextColor(slot.collaborationStatus!),
                      ),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                ),
